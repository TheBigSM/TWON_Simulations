...
function fetchAllPosts() {
  ...
  const post2 = await Post.find().populate([{path : "reposts",  model: "Repost",      select: "createdAt _id"},
                                            {path : "likes",    model: "PostLike",    select: "createdAt _id"}, 
                                            {path : "dislikes", model: "PostDislike", select: "createdAt _id"}, 
                                            {path : "comments", model: "Comment",     select: "createdAt _id", populate: {path : "likes", model: "CommentLike", select: "createdAt _id"}}, {path : "comments", model: "Comment", select: "createdAt _id", populate: {path : "dislikes", model: "CommentDislike", select: "createdAt _id"}}]).exec();//.sort({ createdAt: 'descending' })
  const items = [];
